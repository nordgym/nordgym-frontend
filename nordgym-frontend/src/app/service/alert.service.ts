...
import {AlertType} from '../model/enum/alert-type.enum';
...
export class AlertService {
  ...
  error(errors: string[], message?: string, alertId?: string) {
    this.alert(new Alert({errors, message, type: AlertType.Error, alertId }));
  }
